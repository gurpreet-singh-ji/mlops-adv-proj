...
CONFIG = {
    ...
    "test_size": 0.2,
    "mlflow_tracking_uri": "https://dagshub.com/gurpreet-singh-ji/mlops-adv-proj.mlflow",
    "dagshub_repo_owner": "gurpreet-singh-ji",
    "dagshub_repo_name": "mlops-adv-proj",
...
def lemmatization(text):
    ...
    word = " ".join([lemmatizer.lemmatize(word) for word in text.split()])
    return word
